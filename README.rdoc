...
* Some other plugins depends on other external programs/libraries. Please refer to plugins' documentation for more information.
...
== Update
  ...
  pip install --user --no-binary :all: pynvim # denite requires this
